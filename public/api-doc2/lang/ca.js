...
window.SwaggerTranslator.learn({
    "Warning: Deprecated":"AdvertÃ¨ncia: Obsolet",
    "Implementation Notes":"Notes d'implementaciÃ³",
    "Response Class":"Classe de la Resposta",
    "Status":"Estatus",
    "Parameters":"ParÃ metres",
    "Parameter":"ParÃ metre",
    "Value":"Valor",
    "Description":"DescripciÃ³",
    "Parameter Type":"Tipus del ParÃ metre",
    ...
    "Request URL":"URL de la SolÂ·licitud",
    "Response Body":"Cos de la Resposta",
    "Response Code":"Codi de la Resposta",
    "Response Headers":"CapÃ§aleres de la Resposta",
    ...
    "See more at":"Veure mÃ©s en",
    "Contact the developer":"Contactar amb el desenvolupador",
    "api version":"versiÃ³ de la api",
    ...
    "Can't read from server.  It may not have the appropriate access-control-origin settings.":"No es pot llegir del servidor. Potser no teniu la configuraciÃ³ de control d'accÃ©s apropiada.",
    ...
    "Finished Loading Resource Information. Rendering Swagger UI":"Finalitzada la cÃ rrega del recurs informatiu. Renderitzant Swagger UI",
