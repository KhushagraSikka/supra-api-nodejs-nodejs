...
window.SwaggerTranslator.learn({
    ...
    "Raw":"Grezzo (raw)",
    "can't parse JSON.  Raw result":"non ̬ possibile parsare il JSON. Risultato grezzo (raw).",
    ...
    "Can't read from server.  It may not have the appropriate access-control-origin settings.":"Non ̬ possibile leggere dal server. Potrebbe non avere le impostazioni di controllo accesso origine (access-control-origin) appropriate.",
